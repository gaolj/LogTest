...
BOOST_AUTO_TEST_CASE(sources_net_connection_chan)
{
    ...
    sink->locked_backend()->add_stream(
        boost::make_shared< std::ofstream >("logs/sources_net_connection_chan-net.log"));
    ...
    sink->locked_backend()->add_stream(
        boost::make_shared< std::ofstream >("logs/sources_net_connection_chan-stat.log"));
